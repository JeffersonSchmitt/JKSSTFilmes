package com.github.jeffersonschmitt.jksttfilmes.data;
...
public class FilmesDBHelper extends SQLiteOpenHelper {
  ...
  private static final String DATA_BASE_NAME = "JKSSTFilmes.db";
  ...
  @Override public void onCreate(SQLiteDatabase db) {
    String sqlTableFilmes = "CREATE TABLE " + FilmesContract.FilmeEntry.TABLE_NAME + " (" +
        ...
        FilmesContract.FilmeEntry.COLUNM_DESCRICAO + " TEXT NOT NULL, " +
